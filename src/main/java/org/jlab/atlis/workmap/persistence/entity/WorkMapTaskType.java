 ...
 */
@Entity
@Table(name = "WORK_MAP_TASK_TYPE", schema = "ATLIS_OWNER", uniqueConstraints = {
...
public class WorkMapTaskType implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.workMapTaskTypeId == null && other.workMapTaskTypeId != null) || (this.workMapTaskTypeId != null && !this.workMapTaskTypeId.equals(other.workMapTaskTypeId))) {
            return false;
        }
        return true;
    }
