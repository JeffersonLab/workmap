...
(
    ...
    ICON_ONLY_YN             CHAR(1 CHAR) DEFAULT 'N' NOT NULL CONSTRAINT WORK_MAP_TASK_AREA_CK1 CHECK (ICON_ONLY_YN IN ('Y', 'N')) ,
...
(
	...
	CONSTRAINT WORK_MAP_TASK_PK PRIMARY KEY (WORK_MAP_TASK_ID) ,
        ...
        CONSTRAINT WORK_MAP_TASK_FK1 FOREIGN KEY (WORK_MAP_ID) REFERENCES WORKMAP_OWNER.WORK_MAP (WORK_MAP_ID) ON DELETE CASCADE ,
        CONSTRAINT WORK_MAP_TASK_FK2 FOREIGN KEY (WORK_MAP_TASK_AREA_ID) REFERENCES WORKMAP_OWNER.WORK_MAP_TASK_AREA (WORK_MAP_TASK_AREA_ID) ON DELETE CASCADE ,
        CONSTRAINT WORK_MAP_TASK_FK3 FOREIGN KEY (WORK_MAP_TASK_TYPE_ID) REFERENCES WORKMAP_OWNER.WORK_MAP_TASK_TYPE (WORK_MAP_TASK_TYPE_ID) ON DELETE SET NULL
);
...
(
    ...
    CONSTRAINT WORK_MAP_PSS_FK1 FOREIGN KEY (WORK_MAP_ID) REFERENCES WORKMAP_OWNER.WORK_MAP (WORK_MAP_ID) ON DELETE CASCADE ,
    CONSTRAINT WORK_MAP_PSS_FK2 FOREIGN KEY (WORK_MAP_PSS_AREA_ID) REFERENCES WORKMAP_OWNER.WORK_MAP_PSS_AREA (WORK_MAP_PSS_AREA_ID) ON DELETE CASCADE ,
    CONSTRAINT WORK_MAP_PSS_FK3 FOREIGN KEY (WORK_MAP_PSS_STATE_ID) REFERENCES WORKMAP_OWNER.WORK_MAP_PSS_STATE (WORK_MAP_PSS_STATE_ID) ON DELETE SET NULL
);
